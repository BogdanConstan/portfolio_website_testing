      ...
      <div className="one-second-animation" >
        ...
        {this.state.currentlyShowing === "None" ?
          <div className="containers" >
            ...
            <h2><a href="https://raw.githubusercontent.com/BogdanConstan/BogdanConstan.github.io/gh-pages/Bogdan_Constan_Resume.pdf" id="PDF-link" rel="noopener noreferrer" target="_blank" >Download PDF Version</a></h2>
