...
function About() {
  ...
  return (
    ...
    <div className="components" id="about-div">
      ...
      <p className="p" id="about" >Outside of Software, I love to travel!! I’ve been fortunate enough to visit over 25 countries and you can see some of my highlights below.</p> 
      <PhotoGallery />
    </div>
